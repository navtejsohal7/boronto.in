...
<div class='col-xm-100'>
	<div class='col-xm-10'>
		...
		while($row=mysqli_fetch_array($query,MYSQLI_ASSOC))
		{
		$query1=mysqli_query($connection,"SELECT * FROM subcategory WHERE subcategory_id = '$row[subcategory_id]'");
		while($row1=mysqli_fetch_array($query1,MYSQLI_ASSOC))
			{
			print_r($row1);
			echo "
			<a href='//www.boronto.in/script/".$_GET['category']."/".$row1['subcategory_name']."' class='ad-show'>
				<div class='left'>
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, user_uploads.created, category2_ads.subcategory_id, category2_ads.adtitle, category2_ads.ad_description, category2_ads.phone_number, category2_ads.price, category2_ads.email,category2_ads.session_id FROM user_uploads INNER JOIN category2_ads ON user_uploads.user_id_fk=category2_ads.session_id GROUP BY category2_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		while($row1=mysqli_fetch_array($query1,MYSQLI_ASSOC))
			...
			print_r($row1);
			echo "
			<a href='//www.boronto.in/script/".$_GET['category']."/".$row1['subcategory_name']."/".$row['adtitle']."-".$row['session_id']."' class='ad-show'>
				<div class='left'>
					<img src='//boronto.in/script/".$row['image_name']."'>
				</div>
				<div class='right'>
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category6_ads.session_id, category6_ads.subcategory_id, category6_ads.adtitle, category6_ads.ad_description, category6_ads.phone_number, category6_ads.email FROM user_uploads INNER JOIN category6_ads ON user_uploads.user_id_fk=category6_ads.session_id  GROUP BY category6_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category9_ads.session_id, category9_ads.subcategory_id, category9_ads.adtitle, category9_ads.ad_description, category9_ads.phone_number, category9_ads.price, category9_ads.email FROM user_uploads INNER JOIN category9_ads ON user_uploads.user_id_fk=category9_ads.session_id GROUP BY category9_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category10_ads.session_id, category10_ads.subcategory_id, category10_ads.adtitle, category10_ads.ad_description, category10_ads.phone_number, category10_ads.price, category10_ads.email FROM user_uploads INNER JOIN category10_ads ON user_uploads.user_id_fk=category10_ads.session_id GROUP BY category10_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category12_ads.session_id, category12_ads.subcategory_id, category12_ads.adtitle, category12_ads.ad_description, category12_ads.phone_number, category12_ads.price, category12_ads.email FROM user_uploads INNER JOIN category12_ads ON user_uploads.user_id_fk=category12_ads.session_id GROUP BY category12_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category13_ads.session_id, category13_ads.subcategory_id, category13_ads.adtitle, category13_ads.ad_description, category13_ads.phone_number, category13_ads.price, category13_ads.email FROM user_uploads INNER JOIN category13_ads ON user_uploads.user_id_fk=category13_ads.session_id  GROUP BY category13_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
		...
		$query=mysqli_query($connection,"SELECT user_uploads.image_name, category15_ads.session_id, category1_ads.subcategory_id, category15_ads.adtitle, category15_ads.ad_description, category15_ads.phone_number, category15_ads.age, category15_ads.email FROM user_uploads INNER JOIN category15_ads ON user_uploads.user_id_fk=category15_ads.session_id GROUP BY category15_ads.session_id");
		$count=mysqli_num_rows($query);
		if($count<1)
		{
		echo "
